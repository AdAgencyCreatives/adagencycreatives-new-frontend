  ...
  return (
    <nav className="flex flex-col gap-[21px] font-bold relative">
      {/* {!isHomePage && (
        <Link
          href="/"
          className="text-[19px] xl:text-[21px] 2xl:text-[29px] transition delay-150 duration-300 ease-in-out text-white hover:text-primary cursor-pointer"
        >
          home
        </Link>
      )} */}
      <Link
        href="/faq"
        className="text-[24px] 3xl:text-[32px] 4xl:text-[42px] transition delay-150 duration-300 ease-in-out text-white hover:text-primary cursor-pointer"
      ...
      {isTheLounge && (
        <>
          ...
          <Link
            href="/agencies"
            className="text-[24px] 3xl:text-[32px] 4xl:text-[42.67px] transition delay-150 duration-300 ease-in-out text-white hover:text-primary cursor-pointer"
            onClick={() => setIsOpen && setIsOpen(false)}
          >
            agencies
          </Link>
