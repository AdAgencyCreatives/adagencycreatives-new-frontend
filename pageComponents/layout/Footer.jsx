          ...
          <div className="flex justify-between">
            ...
            <div>
              <div className="space-x-4 2xl:space-x-8 3xl:space-x-12 4xl:space-x-16">
                <a href="#" className="font-inter font-bold lowercase text-[14px] 2xl:text-[18px] 3xl:text-[24px] 4xl:text-[32px] transition delay-150 duration-300 ease-in-out text-[#6E6E6E] hover:text-[#FFFFFF] leading-[20px]">privacy policy</a>
                <a href="#" className="font-inter font-bold lowercase text-[14px] 2xl:text-[18px] 3xl:text-[24px] 4xl:text-[32px] transition delay-150 duration-300 ease-in-out text-[#6E6E6E] hover:text-[#FFFFFF] leading-[20px]">user agreement</a>
                <a href="#" className="font-inter font-bold lowercase text-[14px] 2xl:text-[18px] 3xl:text-[24px] 4xl:text-[32px] transition delay-150 duration-300 ease-in-out text-[#6E6E6E] hover:text-[#FFFFFF] leading-[20px]">contact us</a>
              </div>
