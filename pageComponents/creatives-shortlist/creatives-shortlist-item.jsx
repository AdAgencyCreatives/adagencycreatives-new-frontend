...
const CreativesShortlistItem = ({ item, openNotesDialog, openMessageDialog, removeFromShortlist }) => {

    const router = useRouter();

    return (
        <>
            <div className="creatives-shortlist-item relative flex flex-col items-center w-full max-sm:my-[0.867rem] my-[0.711rem] md:my-[0.867rem] xl:my-[0.949rem] 2xl:my-[1rem] 3xl:my-[1.333rem] 4xl:my-[1.778rem]">
...
export default CreativesShortlistItem;
