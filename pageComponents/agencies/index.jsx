...
const Agencies = () => {
  ...
  return (
    <div className="bg-black text-white pt-[100px]">
      ...
      {/* Plans */}
      <section id="plans" className="md:my-25 py-4 md:py-20 relative border-white border-y-0">
        {/* Background */}
        ...
        <div className="px-10 relative z-1">
          ...
          <div className="grid grid-cols-4 gap-x-[12px] md:gap-x-[54px] 3xl:gap-x-[72px] 4xl:gap-x-[92px] w-full items-center relative py-2 md:py-20 2xl:px-20 3xl:px-40">
            {/* <!-- Column 1: 1 item --> */}
            <div>
              <ResourceLoopItem 
          ...
          <div className="flex items-center justify-end 2xl:px-20 3xl:px-40">
            <Image src="/aac-logo-yellow.png" alt="" width="500" height="500" className="hover:rotate-45 transition-transform duration-3000 w-[21px] h-[21px] md:w-[80px] md:h-[80px] 3xl:w-[106px] 3xl:h-[106px] 4xl:w-[142px] 4xl:h-[142px]"/>
            ...
            <Link 
              href="/" 
              className="border-yellow-400 bg-black border-[1.21px] md:border-[4.65px] 3xl:border-[6.2px 4xl:border-[8.27px] md:border-4 uppercase text-yellow-400 rounded-full font-inter 4xl:font-semibold text-[4.69px] md:text-lg 3xl:text-2xl 4xl:text-[32px] px-5 py-1 md:px-16 md:py-[13px] 3xl:px-[86px] 3xl:py-[22px] 4xl:px-16 4xl:py-6 cursor-pointer hover:border-white hover:bg-yellow-400 hover:text-white"
            >
              Get Featured
            </Link>
          </div>
      ...
      {/* Create Profile */}
      <section className="md:py-20 px-6 md:px-10 mb-20" id="post-job">
        ...
        <p className="text-sm md:text-[42px] 3xl:text-[56px] 4xl:text-[75px] text-white font-arial font-bold">Create. Inspire. <span className="text-yellow-400">Hire!</span></p>
          ...
          <div className='outline outline-4 md:outline-8 2xl:outline-16 shadow-(--ad-box-shadow) outline-while rounded-lg mt-12 md:mt-30 px-2 md:px-10 py-2 pb-4 md:pb-4 mb-2 relative mx-[4px] md:mx-[16px]'>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-1 md:gap-10 justify-between ">
              ...
              <div className=" md:pt-10 pb-10 md:pb-14 2xl:pb-20 3xl:pb-24 4xl:pb-28">
                ...
                <p className="font-alta text-xs md:text-sm 3xl:text-lg 4xl:text-2xl">Detroit, MI</p>
              ...
              <div>
                <div className="max-w-[130px] md:max-w-[220px] 3xl:max-w-[295px] 4xl:max-w-[393px] mx-auto -mt-12 3xl:-mt-16 bg-black relative z-1">
                  <CreativeLoopItem2 
                    creative={{ title: 'Creative Director', image: '/jobs/job3.avif', agency: 'AD CORP.', location: 'Detroit, MI' }}
                  />
                </div>
              </div>
            </div>
