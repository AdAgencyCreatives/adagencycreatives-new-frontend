...
const Agencies = () => {
  ...
  return (
    <div className="bg-black text-white pt-[100px]">
      ...
      {/* Featured Creatives */}
      <section id="creatives" className="p-6 md:py-10 md:px-10 mx-auto relative z-1">
        <h2 className="text-[22px] md:text-[78px] 3xl:text-[104px] 4xl:text-[139px] font-bold mb-0 2xl:px-20 3xl:px-40 py-7 2xl:mb-20 3xl:mb-30">Featured Creatives</h2>
          ...
          {featuredCreatives.map((creative, idx) => (
            <>
              {idx === 6 && (
                ...
                <h2 className="text-2xl md:text-[44px] md:leading-[58.5px] 3xl:text-[57.07px] 3xl:leading-[78px] 4xl:text-[76.09px] 4xl:leading-[104px] font-bold">Haven't<br />Found<br />The Perfect<br />Match?</h2>
                  <div>
                    <Link 
                      href="/" 
              ...
              {width > 767 && idx === 15 && (
                <div key={`profile-${idx}`} className="col-span-2 text-center flex flex-col justify-around gap-10">
                  <h2 className="text-2xl md:text-[44px] md:leading-[58.5px] 3xl:text-[57.07px] 3xl:leading-[78px] 4xl:text-[76.09px] 4xl:leading-[104px] font-bold">Why<br />Search?<br />Post & Attract!</h2>
                  <div>
                    <Link 
                      href="/" 
      ...
      {/* Plans */}
      <section id="plans" className="my-25 py-20 relative border-white border-y-0">
        {/* Background */}
        ...
        <div className="px-10 relative z-1 ">
          ...
          <div className="flex items-center justify-end my-5 2xl:px-20 3xl:px-40">
            <Image src="/aac-logo-yellow.png" alt="" width="67" height="67" className="hover:rotate-45 transition-transform duration-3000 w-[112px] h-[112px]"/>
      ...
      <section className="md:py-20 px-6 md:px-10">
        <h2 id="create-profile" className="text-[22px] md:text-[78px] 3xl:text-[104px] 4xl:text-[143px] 2xl:pl-20 3xl:pl-40 font-bold relative inline-block">Post a Job</h2>
        ...
        <p className="text-sm md:text-[42px] 3xl:text-[56px] 4xl:text-[75px] text-white">Post. Attract. <span className="text-yellow-400">Hire!</span></p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-left mt-8 md:mt-16 2xl:mt-30 3xl:mt-40 4xl:mt-53">
          <div className="font-wix flex flex-col gap-1 md:gap-2 2xl:gap-3 3xl:gap-4">
            ...
            <p className="text-yellow-400 font-hass75 text-xs font-bold md:text-lg 3xl:text-2xl 4xl:text-2xl">CREATE A JOB</p>
          ...
          <div className="font-wix flex flex-col gap-1 md:gap-2 2xl:gap-3 3xl:gap-4">
            ...
            <p className="text-yellow-400 font-hass75 text-xs font-bold md:text-lg 3xl:text-2xl 4xl:text-2xl">GET FEATURED & SHOWCASE</p>
            <p className="text-white text-xs md:text-base 3xl:text-2xl 4xl:text-[32px]">Showcase your agency.<br />This isn’t just a listing - it’s your presence in a curated space built for visibility and recognition. Your ProFile™ connects your brand, culture, and creative energy in one place that speaks volumes. Get featured. Be remembered. This is where standout agencies meet standout talent.</p>
          </div>
          <div className="font-wix flex flex-col gap-1 md:gap-2 2xl:gap-3 3xl:gap-4">
            ...
            <p className="text-yellow-400 font-hass75 text-xs font-bold md:text-lg 3xl:text-2xl 4xl:text-2xl">HIRE</p>
            <p className="text-white text-xs md:text-base 3xl:text-2xl 4xl:text-[32px]">Find who you're really looking for.<br />No endless scrolling. No guessing games. Just a curated network of standout creatives - ready to jump in, lead, or elevate your next project. Message directly. Review ProFile™s. Build your dream team. This is hiring, reimagined. On your terms, at your pace, with talent that gets it.</p>
          </div>
        </div>
