...
const ResourceLoopItem = ({ resource }) => {
  return (
    <div className="rounded-md md:rounded-2xl outline outline-3 md:outline-8 lg:outline-12 3xl:outline-16 4xl:outline-21 outline-white shadow-light md:shadow-(--ad-box-shadow) transition relative bg-black pt-3 md:pt-0 mb-4 md:mb-12 3xl:mb-14 4xl:mb-20 ">
      ...
      <div className="absolute bottom-2 left-2 md:bottom-5 md:left-5">
        ...
        <p className="text-white lowercase resource-title mt-1 sm:mb-4 font-bold font-inter">{resource.title}</p>
      </div>
    </div>
  );
};
