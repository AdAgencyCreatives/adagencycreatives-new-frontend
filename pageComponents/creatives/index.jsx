  ...
  return (
    <div className="text-white">
      ...
      <div className="bg-black heading-wrap relative z-1">
        <h2 className="heading font-bold font-inter text-[22px] md:text-[78px] 3xl:text-[104px] 4xl:text-[139px] leading-[25.78px] 2xl:leading-[99px] 3xl:leading-[132px] 4xl:leading-[176px]">Featured Jobs</h2>
      </div>
      <section className="relative z-1 featured-jobs" id="search-jobs">
      ...
      <div className="bg-black heading-wrap">
        <h2 className="heading font-bold font-inter text-right text-[22px] md:text-[78px] 3xl:text-[104px] 4xl:text-[139px] leading-[25.78px] 2xl:leading-[99px] 3xl:leading-[132px] 4xl:leading-[176px]">Resources</h2>
      </div>
      ...
      {/* Featured Creatives */}
      <div className="bg-black heading-wrap">
        <h2 className="heading font-bold font-inter text-right text-[22px] md:text-[78px] 3xl:text-[104px] 4xl:text-[139px] leading-[25.78px] 2xl:leading-[99px] 3xl:leading-[132px] 4xl:leading-[176px]">Featured Creatives</h2>
      </div>
      <section className="featured-creatives">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
      ...
      {/* Create Profile */}
      <div className="bg-[#040404] heading-wrap">
        <h2 className="heading font-bold font-inter text-[22px] md:text-[78px] 3xl:text-[104px] 4xl:text-[143px] leading-[25.78px] 2xl:leading-[99px] 3xl:leading-[132px] 4xl:leading-[176px]">Create ProFile<sup className='text-[10px] md:text-[14px] xl:text-[18px] 3xl:text-[22px] 4xl:text-[26px] relative -top-[10px] md:-top-[30px] 3xl:-top-[50px] 4xl:-top-[60px]'>TM</sup></h2>
      </div>
      <section className="bg-black">
        <div className="flex flex-col md:gap-[7.5rem] 3xl:gap-[10rem] 4xl:gap-[13.333rem]">
          <div className="clients">
            ...
            <p className="text-sm md:text-[42px] 3xl:text-[56px] text-white font-arial font-bold inspire">Create. Inspire. <span className="text-brand-yellow">Get Hired!</span></p>
          </div>
          <div className="steps">
        ...
        <div className="creative">
          <div className="outline outline-4 md:outline-8 2xl:outline-16 shadow-(--ad-box-shadow) outline-while rounded-lg relative mx-[4px] md:mx-[16px]">
            <div className="grid grid-cols-2 md:grid-cols-3 gap-1 md:gap-10 justify-between">
              ...
              <div className="pb-10 md:pb-14 2xl:pb-20 3xl:pb-24 4xl:pb-28 font-inter details">
                <div>
                  <h2 className="text-lg md:text-[34px] 3xl:text-[46px] 4xl:text-[3.75rem] font-bold uppercase">Matthew Marcos</h2>
                  <p className="lowercase font-bold text-brand-yellow text-xs md:text-2xl 3xl:text-3xl 4xl:text-[2.5rem] my-2 md:my-4">Creative Director</p>
                </div>
                <p className="text-xs md:text-sm 3xl:text-lg 4xl:text-2xl">NEW YORK, NY</p>
                <p className="text-xs md:text-lg 3xl:text-[32px] 4xl:text-[32px] text-brand-yellow mt-4 mb-2 md:my-4">ABOUT</p>
                <p className="leading-[14px] md:leading-[24px] 3xl:leading-[32px] 4xl:leading-[40px] text-[11px] md:text-base 3xl:text-2xl 4xl:text-[28px]">I'm an Associate Creative Director based in New York City; with a focus on art direction, brand storytelling, and concepting big ideas.I’ve been fortunate to work with brands like Keds, Louis XIII, Marantz, Wrangler, J.Crew, and USTA, crafting campaigns </p>
                <Link href="/" className="text-xs md:text-base 3xl:text-2xl 4xl:text-[28px] text-brand-yellow underline mt-6">Read more...</Link>
              </div>
              <div>
