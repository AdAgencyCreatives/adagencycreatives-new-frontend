    ...
    <div className="text-white">
      ...
      <section className="relative flex flex-col justify-center text-center page-header">
        ...
        <div className="font-bold space-x-6 2xl:space-x-[36px] 3xl:space-x-[48px] 4xl:space-x-[64px] text-sm md:text-2xl 3xl:text-[32px] 4xl:text-[42.67px] text-brand-yellow relative z-1">
          <a href="#create-profile" className="sub-heading">create ProFile<sup className='font-hass65 text-[8px] md:text-[10px] xl:text-[10px] 3xl:text-[16px] 4xl:text-[18px] relative md:-top-[12px] 3xl:-top-[16px]'>TM</sup></a>
            ...
            <React.Fragment key={`creative-${creative.id || idx}`}>
              ...
              {width > 767 && idx === 15 && (
                <div key={`profile-${idx}`} className="relative col-span-2 text-center flex flex-col justify-around gap-10">
                  ...
                  <h2 className="relative z-1 font-inter font-bold">Want<br />Your ProFile<sup className='font-hass65 text-[8px] md:text-[12px] xl:text-[14px] 3xl:text-[18px] 4xl:text-[20px] relative -top-[10px] md:-top-[20px] 3xl:-top-[30px] 4xl:-top-[40px]'>TM</sup><br />Featured?</h2>
                  <div className="relative z-1">
          ...
          <div className="steps">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-12 text-left">
              <div className="font-wix flex flex-col gap-[5.62] md:gap-2 2xl:gap-5.5 3xl:gap-7 4xl:gap-9.5">
                ...
                <p className="text-brand-yellow font-bold step-heading font-inter ">CREATE ProFile<sup className='font-hass65 text-[8px] md:text-[10px] 3xl:text-[12px] relative -top-[6px] md:-top-[10px]'>TM</sup></p>
              ...
              <div className="font-wix flex flex-col gap-[5.62] md:gap-2 2xl:gap-5.5 3xl:gap-7 4xl:gap-9.5">
                ...
                <p className="text-white step-desc font-inter font-normal">Be seen where it matters.<br />Your ProFile™ becomes part of a curated network - handpicked creatives, thinkers, and builders. Stand out in The Lounge, and The Agencies Homepage where talent is more than a portfolio - it’s a presence. No chasing. No noise. Just the right eyes on your work.</p>
              </div>
              <div className="font-wix flex flex-col gap-[5.62] md:gap-2 2xl:gap-5.5 3xl:gap-7 4xl:gap-9.5">
