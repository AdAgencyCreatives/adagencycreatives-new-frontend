      ...
      <div className="grid grid-cols-3 gap-14 relative">
        ...
        >
          <div className="flex flex-col gap-14">
            <div>
              <p className="font-alta font-bold uppercase text-base text-primary mb-2">Years of Experience</p>
              <p className="lowercase hover:text-primary text-white text-xl">{user.experience}</p>
            </div>
            <div>
              <p className="font-alta font-bold uppercase text-base text-primary mb-2">Industry Experience</p>
              <p className="lowercase hover:text-primary text-white text-xl">{user.industry}</p>
            </div>
            <div>
              <p className="font-alta font-bold uppercase text-base text-primary mb-2">Media Experience</p>
              <p className="lowercase hover:text-primary text-white text-xl">{user.media}</p>
            </div>
            <div>
              <p className="font-alta font-bold uppercase text-base text-primary mb-2">Type of Work</p>
              <p className="lowercase hover:text-primary text-white text-xl">{user.work}</p>
            </div>
            <div>
              <p className="font-alta font-bold uppercase text-base text-primary mb-2">Strengths</p>
              <p className="lowercase hover:text-primary text-white text-xl">{user.strength}</p>
            </div>
          </div>
        </div>
      </div>
