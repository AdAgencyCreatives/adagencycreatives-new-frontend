  ...
  return (
    <div className="relative px-1 py-3 mb:py-[15.75px] 2xl:py-[33.75px] 3xl:py-[44.74px] 4xl:py-[60px] rounded-2xl md:rounded-4xl border-white border-[0.72px] md:border-2 shadow-down md:shadow-(--ad-box-shadow) text-center flex flex-col justify-between items-center gap-2 4xl:gap-4">
      ...
      <div className="w-full mt-2.5 2xl:mt-4 3xl:mt-5.5 4xl:mt-7">
        <div className="font-alta font-normal text-[11.56px] sm:text-[16px] md:text-[20px] 2xl:text-[28px] 3xl:text-[38px] 4xl:text-[42.67px] hover:text-[#FFCD1A]">{creative.agency}</div>
        <div className="text-white font-inter leading-[16px] md:leading-[20px] 2xl:leading-[24px] 3xl:leading-[25px] 4xl:leading-[34.67px] font-bold text-[8.68px] md:text-[14px] 2xl:text-[16px] 3xl:text-[20px] 4xl:text-[25.21px] hover:text-[#FFCD1A] lowercase">{creative.title}</div>
        ...
        <div className="font-alta leading-[14px] md:leading-[16px] 2xl:leading-[20px] 3xl:leading-[28px] 4xl:leading-[36.4px] text-[5.18px] md:text-[12px] 2xl:text-[14px] 3xl:text-[18px] 4xl:text-[22.97px] hover:text-[#FFCD1A]">{creative.location}</div>
      </div>
    </div>
  );
};
