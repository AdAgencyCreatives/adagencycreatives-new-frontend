...
const CreativeLoopItem2 = ({ creative }) => {
  return (
    <div className="card relative px-1 py-3 mb:py-[15.75px] 2xl:py-[33.75px] 3xl:py-[44.74px] 4xl:py-[60px] rounded-2xl md:rounded-4xl border-white border-[0.72px] md:border-2 shadow-down md:shadow-(--ad-box-shadow) text-center flex flex-col justify-between items-center gap-2 4xl:gap-4">
      ...
      <div className="w-full mt-2.5 2xl:mt-4 3xl:mt-5.5 4xl:mt-7">
        <div className="font-inter font-bold hover:text-brand-yellow name">{creative.agency}</div>
