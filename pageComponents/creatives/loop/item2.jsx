  ...
  return (
    <div className="card design-2 relative px-1 py-3 mb:py-[15.75px] 2xl:py-[33.75px] 3xl:py-[44.74px] 4xl:py-[60px] rounded-2xl md:rounded-4xl border-white border-[0.72px] md:border-2 shadow-down md:shadow-(--ad-box-shadow) text-center flex flex-col justify-between items-center gap-2">
      ...
      <div className="w-full mt-1.5 2xl:mt-1 3xl:mt-2.5 4xl:mt-3">
        <div className="font-inter font-bold text-white uppercase name">{creative.agency}</div>
        <div className="text-white font-inter leading-[16px] md:leading-[20px] 2xl:leading-[24px] 3xl:leading-[25px] 4xl:leading-[34.67px] font-bold lowercase title">{creative.title}</div>
        ...
        <div className="font-inter text-white font-bold leading-[14px] md:leading-[16px] 2xl:leading-[20px] 3xl:leading-[28px] 4xl:leading-[36.4px] location">{creative.location}</div>
      </div>
    </div> 
  );
};
