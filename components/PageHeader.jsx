...
const PageHeader = ({ page, subPage, heading }) => {
  return (
    <>
      ...
      <div 
        className="z-0 absolute w-full zoom-35 zoom-60 zoom-70 zoom-80 zoom-90 inset-0 m-auto z-0 max-sm:w-[70%] max-md:w-[50%] max-md:aspect-square max-md:rounded-full max-md:overflow-hidden"
